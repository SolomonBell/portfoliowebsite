...
export default function CertFlipCard({ cert }: { cert: Certificate }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front — no overflow:hidden on this direct preserve-3d child */}
        <div
        ...
        >
          {/* Inner wrapper handles all visual clipping */}
          <div
        ...
        {/* Back — no overflow:hidden on this direct preserve-3d child */}
        <div
          className="absolute inset-0 rounded-2xl border border-white/10"
          style={{
            backfaceVisibility: "hidden",
        ...
        >
          {/* Inner wrapper handles all visual clipping */}
          <div className={`absolute inset-0 rounded-2xl overflow-hidden ${cert.backClassName} p-5 flex flex-col`}>
